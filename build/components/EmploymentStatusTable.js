...
function EmploymentStatusTable() {
    var initialEmployees = [
        { id: 1, GovName: "على رأس عمله", EmpNum: "1 موظف" },
        { id: 2, GovName: "في إجازة مؤقتة", EmpNum: "10 موظفين" },
        { id: 3, GovName: "متقاعد", EmpNum: "3 موظفين" },
    ];
...
exports.default = EmploymentStatusTable;
