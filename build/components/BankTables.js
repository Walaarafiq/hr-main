...
function BankTables() {
    var initialEmployees = [
        { id: 1, GovName: "بنك فلسطين", EmpNum: "1 موظف" },
        { id: 2, GovName: "البنك الإسلامي الفلسطيني", EmpNum: "10 موظفين" },
        { id: 3, GovName: "البنك الإسلامي العربي", EmpNum: "3 موظفين" },
    ];
