...
function TypeOfEmpTable() {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("div", { className: "card mt-4", style: { overflow: 'visible' }, children: (0, jsx_runtime_1.jsxs)("div", { className: "card-body", children: [(0, jsx_runtime_1.jsxs)("table", { className: "table table-bordered text-center align-middle", children: [(0, jsx_runtime_1.jsx)("thead", { className: "table-light", style: { fontSize: "14px" }, children: (0, jsx_runtime_1.jsxs)("tr", { children: [(0, jsx_runtime_1.jsx)("th", { children: "\u0645" }), (0, jsx_runtime_1.jsx)("th", { children: "\u0627\u0644\u0648\u0632\u0627\u0631\u0629" }), (0, jsx_runtime_1.jsx)("th", { children: "\u0639\u062F\u062F \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646" }), (0, jsx_runtime_1.jsx)("th", { children: "\u0627\u0644\u0625\u062C\u0631\u0627\u0621\u0627\u062A" })] }) }), (0, jsx_runtime_1.jsx)("tbody", { style: { fontSize: "13px" }, children: currentData.map(function (emp, index) { return ((0, jsx_runtime_1.jsxs)("tr", { children: [(0, jsx_runtime_1.jsx)("td", { children: (currentPage - 1) * itemsPerPage + index + 1 }), (0, jsx_runtime_1.jsx)("td", { children: emp.GovName }), (0, jsx_runtime_1.jsx)("td", { children: emp.EmpNum }), (0, jsx_runtime_1.jsxs)("td", { children: [(0, jsx_runtime_1.jsx)("button", { className: "btn btn-sm btn-outline-danger me-2", onClick: function () { return handleDelete(emp.id); }, children: "\uD83D\uDDD1" }), (0, jsx_runtime_1.jsx)("button", { className: "btn btn-sm btn-outline-primary me-2", onClick: function () { return openEditModal(emp); }, children: "\u270F" }), (0, jsx_runtime_1.jsx)("button", { className: "btn btn-sm btn-outline-warning me-2", onClick: function () { return openViewModal(emp); }, children: "\uD83D\uDC41" })] })] }, emp.id)); }) })] }), (0, jsx_runtime_1.jsxs)("div", { className: "d-flex justify-content-center align-items-center mt-3", children: [(0, jsx_runtime_1.jsx)("button", { className: "btn btn-outline-dark me-1", onClick: handlePrev, disabled: currentPage === 1, children: "< \u0627\u0644\u0633\u0627\u0628\u0642" }), Array.from({ length: totalPages }, function (_, i) { return i + 1; }).map(function (page) { return ((0, jsx_runtime_1.jsx)("button", { className: "btn me-1 ".concat(page === currentPage ? 'btn-dark' : 'btn-outline-dark'), onClick: function () { return setCurrentPage(page); }, children: page }, page)); }), (0, jsx_runtime_1.jsx)("button", { className: "btn btn-outline-dark me-1", onClick: handleNext, disabled: currentPage === totalPages, children: "\u0627\u0644\u062A\u0627\u0644\u064A >" })] })] }) }), showModal && selectedEmployee && ((0, jsx_runtime_1.jsx)("div", { style: {
                    ...
                    justifyContent: "center", alignItems: "center", zIndex: 1000
                        ...
                        maxHeight: "90%",
                        overflowY: "auto"
                    }, children: [(0, jsx_runtime_1.jsx)("h5", { children: isEdit ? "تعديل بيانات الموظف" : "عرض بيانات الموظف" }), (0, jsx_runtime_1.jsxs)("div", { className: "mb-3", children: [(0, jsx_runtime_1.jsx)("label", { className: "form-label", children: "\u0627\u0644\u0648\u0632\u0627\u0631\u0629" }), (0, jsx_runtime_1.jsx)("input", { type: "text", className: "form-control", value: selectedEmployee.GovName, onChange: function (e) { return isEdit && setSelectedEmployee(__assign(__assign({}, selectedEmployee), { GovName: e.target.value })); }, disabled: !isEdit })] }), (0, jsx_runtime_1.jsxs)("div", { className: "mb-3", children: [(0, jsx_runtime_1.jsx)("label", { className: "form-label", children: "\u0639\u062F\u062F \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646" }), (0, jsx_runtime_1.jsx)("input", { type: "text", className: "form-control", value: selectedEmployee.EmpNum, onChange: function (e) { return isEdit && setSelectedEmployee(__assign(__assign({}, selectedEmployee), { EmpNum: e.target.value })); }, disabled: !isEdit })] }), (0, jsx_runtime_1.jsxs)("div", { className: "d-flex justify-content-end", children: [(0, jsx_runtime_1.jsx)("button", { className: "btn btn-secondary me-2 mx-1", onClick: function () { return setShowModal(false); }, children: "\u0625\u063A\u0644\u0627\u0642" }), isEdit && (0, jsx_runtime_1.jsx)("button", { className: "btn btn-primary", onClick: handleSave, children: "\u062D\u0641\u0638" })] })] }) }))] }));
}
exports.default = TypeOfEmpTable;
