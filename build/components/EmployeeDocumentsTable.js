...
function EmployeeDocumentsTable() {
    var initialEmployees = [
        { id: 1, GovName: "الشهادات الأكاديمية", EmpNum: "1 موظف" },
        { id: 2, GovName: "مرفقات إدارية", EmpNum: "10 موظفين" },
    ];
...
exports.default = EmployeeDocumentsTable;
