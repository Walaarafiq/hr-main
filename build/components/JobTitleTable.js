...
function JobTitleTable() {
    ...
    var _d = (0, react_1.useState)(false), isEdit = _d[0], setIsEdit = _d[1];
    ...
    var saveEdit = function () {
        setEmployees(function (prev) { return prev.map(function (emp) { return emp.id === selectedEmployee.id ? selectedEmployee : emp; }); });
        setShowModal(false);
    };
