...
function CourseTypesTables() {
    var initialEmployees = [
        { id: 1, GovName: "تدريب ميداني", EmpNum: "1 موظف" },
        { id: 2, GovName: "دورة", EmpNum: "10 موظفين" },
        { id: 2, GovName: "ورشة", EmpNum: "10 موظفين" },
    ];
...
exports.default = CourseTypesTables;
