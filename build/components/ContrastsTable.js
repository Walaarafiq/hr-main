...
function ContrastsTable(_a) {
    ...
    var totalPages = Math.ceil(safeEmployees.length / itemsPerPage);
    var currentData = safeEmployees.slice((currentPage - 1) * itemsPerPage, currentPage * itemsPerPage);
    ...
    var handleDelete = function (emp) {
        if (!window.confirm("\u0647\u0644 \u0623\u0646\u062A \u0645\u062A\u0623\u0643\u062F \u0645\u0646 \u062D\u0630\u0641 \u0627\u0644\u0645\u0648\u0638\u0641 ".concat(emp.full_name, "\u061F")))
            return;
        setEmployees(function (prev) { return prev.filter(function (e) { return e.id !== emp.id; }); });
    };
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "card mt-4", children: [(0, jsx_runtime_1.jsxs)("div", { className: "card-body", children: [(0, jsx_runtime_1.jsxs)("table", { className: "table table-bordered text-center align-middle", children: [(0, jsx_runtime_1.jsx)("thead", { className: "table-light", children: (0, jsx_runtime_1.jsxs)("tr", { children: [(0, jsx_runtime_1.jsx)("th", { children: "\u0645" }), (0, jsx_runtime_1.jsx)("th", { children: "\u0627\u0644\u0627\u0633\u0645 \u0627\u0644\u0643\u0627\u0645\u0644" }), (0, jsx_runtime_1.jsx)("th", { children: "\u0627\u0644\u062A\u0635\u0646\u064A\u0641" }), (0, jsx_runtime_1.jsx)("th", { children: "\u0631\u0642\u0645 \u0627\u0644\u0647\u0648\u064A\u0629" }), (0, jsx_runtime_1.jsx)("th", { children: "\u0631\u0642\u0645 \u0627\u0644\u0645\u0648\u0638\u0641" }), (0, jsx_runtime_1.jsx)("th", { children: "\u0631\u0642\u0645 \u0627\u0644\u062C\u0648\u0627\u0644" }), (0, jsx_runtime_1.jsx)("th", { children: "\u062A\u0627\u0631\u064A\u062E \u0627\u0644\u0645\u064A\u0644\u0627\u062F" }), (0, jsx_runtime_1.jsx)("th", { children: "\u0627\u0644\u062F\u0627\u0626\u0631\u0629" }), (0, jsx_runtime_1.jsx)("th", { children: "\u0627\u0644\u0645\u0633\u0645\u0649 \u0627\u0644\u0648\u0638\u064A\u0641\u064A" }), (0, jsx_runtime_1.jsx)("th", { children: "\u0627\u0644\u0625\u062C\u0631\u0627\u0621\u0627\u062A" })] }) }), (0, jsx_runtime_1.jsx)("tbody", { children: loading ? ((0, jsx_runtime_1.jsx)("tr", { children: (0, jsx_runtime_1.jsx)("td", { colSpan: "10", children: "\u062C\u0627\u0631\u064D \u0627\u0644\u062A\u062D\u0645\u064A\u0644..." }) })) : currentData.length === 0 ? ((0, jsx_runtime_1.jsx)("tr", { children: (0, jsx_runtime_1.jsx)("td", { colSpan: "10", children: "\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A" }) })) : (currentData.map(function (emp, index) {
                                    var _a;
                                    return ((0, jsx_runtime_1.jsxs)("tr", { children: [(0, jsx_runtime_1.jsx)("td", { children: (currentPage - 1) * itemsPerPage + index + 1 }), (0, jsx_runtime_1.jsx)("td", { children: emp.full_name || "-" }), (0, jsx_runtime_1.jsx)("td", { children: emp.employment_type_name || "-" }), (0, jsx_runtime_1.jsx)("td", { children: emp.national_id || "-" }), (0, jsx_runtime_1.jsx)("td", { children: emp.employee_number || "-" }), (0, jsx_runtime_1.jsx)("td", { children: emp.primary_phone || "-" }), (0, jsx_runtime_1.jsx)("td", { children: emp.birth_date ? emp.birth_date.split("T")[0] : "-" }), (0, jsx_runtime_1.jsx)("td", { children: emp.department_name || "-" }), (0, jsx_runtime_1.jsx)("td", { children: ((_a = emp.work_detail) === null || _a === void 0 ? void 0 : _a.job_title) || "-" }), (0, jsx_runtime_1.jsxs)("td", { children: [(0, jsx_runtime_1.jsx)("button", { className: "btn btn-sm btn-outline-danger me-1", onClick: function () { return handleDelete(emp); }, children: "\uD83D\uDDD1" }), (0, jsx_runtime_1.jsx)("button", { className: "btn btn-sm btn-outline-primary me-1 mx-1", onClick: function () {
                                ...
                                })) })] }), !loading && totalPages > 1 && ((0, jsx_runtime_1.jsxs)("div", { className: "d-flex justify-content-center mt-3", children: [(0, jsx_runtime_1.jsx)("button", { className: "btn btn-outline-dark me-1", onClick: handlePrev, disabled: currentPage === 1, children: "\u0627\u0644\u0633\u0627\u0628\u0642" }), Array.from({ length: totalPages }, function (_, i) { return i + 1; }).map(function (page) { return ((0, jsx_runtime_1.jsx)("button", { className: "btn me-1 ".concat(page === currentPage ? "btn-dark" : "btn-outline-dark"), onClick: function () { return setCurrentPage(page); }, children: page }, page)); }), (0, jsx_runtime_1.jsx)("button", { className: "btn btn-outline-dark", onClick: handleNext, disabled: currentPage === totalPages, children: "\u0627\u0644\u062A\u0627\u0644\u064A" })] }))] }), showWizard && ((0, jsx_runtime_1.jsx)("div", { className: "modal-backdrop show d-flex align-items-center justify-content-center", children: (0, jsx_runtime_1.jsx)("div", { className: "modal-dialog modal-xl", children: (0, jsx_runtime_1.jsxs)("div", { className: "modal-content p-3", children: [modalLoading ? ((0, jsx_runtime_1.jsx)("p", { children: "\u062C\u0627\u0631\u064D \u0627\u0644\u062A\u062D\u0645\u064A\u0644..." })) : selectedEmployee ? ((0, jsx_runtime_1.jsx)(EditEmpWizard_1.default, { employee: selectedEmployee })) : ((0, jsx_runtime_1.jsx)("p", { children: "\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A" })), (0, jsx_runtime_1.jsx)("div", { className: "text-end mt-3", children: (0, jsx_runtime_1.jsx)("button", { className: "btn btn-secondary", onClick: function () { return setShowWizard(false); }, children: "\u0625\u063A\u0644\u0627\u0642" }) })] }) }) })), showEditForm && selectedEmployee && ((0, jsx_runtime_1.jsx)("div", { className: "modal-backdrop show d-flex align-items-center justify-content-center", children: (0, jsx_runtime_1.jsx)("div", { className: "modal-dialog modal-xl", children: (0, jsx_runtime_1.jsxs)("div", { className: "modal-content p-3", children: [(0, jsx_runtime_1.jsx)(EditEmployeesForm_1.default, { employee: selectedEmployee, onSave: function (updatedEmp) {
                                    setEmployees(function (prev) {
                                        return prev.map(function (emp) { return (emp.id === updatedEmp.id ? updatedEmp : emp); });
                                    });
...
exports.default = ContrastsTable;
