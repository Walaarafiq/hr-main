...
function GeneralAdministrationTable() {
    var initialEmployees = [
        { id: 1, GovName: "الإدارة العامة لحماية المستهلك والرقابة والتفتيش", EmpNum: "1 موظف" },
        { id: 2, GovName: "الإدارة العامة للحاسوب وتكنولوجيا المعلومات", EmpNum: "10 موظفين" },
        { id: 3, GovName: "الإدارة العامة للذهب والمعادن الثمينة", EmpNum: "3 موظفين" },
    ];
...
exports.default = GeneralAdministrationTable;
