...
function WorkContractsTable() {
    var initialEmployees = [
        { id: 1, GovName: "عقد دائم ", EmpNum: "1 موظف" },
        { id: 2, GovName: "عقد غير معلوم", EmpNum: "10 موظفين" },
        { id: 3, GovName: "عقد متوقف", EmpNum: "3 موظفين" },
    ];
...
exports.default = WorkContractsTable;
